...
process = cms.Process("testRPCRawToDigiPlotter")
...
process.load("DPGAnalysis.RPC.RPCRawToDigiPlotter_cfi")
process.RPCRawToDigiPlotter.CreatePDF = cms.bool(True)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string("testRPCRawToDigiPlotter.root") )

process.p = cms.Path(process.RPCRawToDigiPlotter)
